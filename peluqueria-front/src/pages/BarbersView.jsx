...
const BarberView = () => {
    ...
    try {
        const res = await fetch("http://localhost:3000/appointments?unassigned=true");
    ...
    const barberId = localStorage.getItem("user_id");
        ...
        try {
        const res = await fetch(`http://localhost:3000/appointments/${turnoId}/assign`, {
            method: "PUT",
            ...
            {turnos.length === 0 ? (
                ...
                <Col md={4} key={turno.id}>
                    ...
                    <Card.Body>
                        ...
                        Cliente ID: {turno.customer_id}
                        </Card.Title>
                        <Card.Text>
                        <strong>Servicio:</strong> {turno.service}<br />
                            <strong>Fecha:</strong> {turno.appointment_date}<br />
